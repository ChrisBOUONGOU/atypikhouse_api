...
/**
 * @extends ServiceEntityRepository<DynamicProperty>
 *
...
class DynamicPropertyRepository extends ServiceEntityRepository
{
    ...
    public function save(DynamicProperty $entity, bool $flush = false): void
    {
    ...
    public function remove(DynamicProperty $entity, bool $flush = false): void
    {
