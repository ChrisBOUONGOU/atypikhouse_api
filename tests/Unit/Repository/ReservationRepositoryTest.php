...
class ReservationRepositoryTest extends KernelTestCase
{
    ...
    public function testFindCollindingReservationsWhenExists()
    {
        ...
        ReservationFactory::createOne(
            [
                "client" => $clientUserForReservation, "offer" => $offer, "startDate" => $reservation1StartDate, "endDate" => $reservation1EndDate, "status" => ReservationStatus::COMPLETED()
            ]
        );
        ...
        $results = $reservationRepository->findByCollindingReservations(null, $reservation2StartDate, $reservation2EndDate, $offer->object());
